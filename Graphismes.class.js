...
const formes = {
	player: {
		display: {
			...
			default: function (id = "canvas", entity, canvas) {
			...
			toUp: function (id = "canvas", entity, canvas) {
				let context = canvas.getContext('2d');
			...
			toDown: function (id = "canvas", entity, canvas) {
				let context = canvas.getContext('2d');
		...
		}, remove: function (id = "canvas", entity, canvas) {
			let context = canvas.getContext('2d');
...
class Graphismes {
	...
	display(entity) {
		formes[entity.type].display[entity.toDisplay]("canvas", entity, this.party.canvas);
		this.party.sendCanvasToAllPlayers();
	}

	hide(entity) {
		formes[entity.type].remove("canvas", entity, this.party.canvas);
		this.party.sendCanvasToAllPlayers();
	}
