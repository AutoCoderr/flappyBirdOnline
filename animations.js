...
const entities = require("./entities"),
    checkCollisions = entities.checkCollisions;

const msDefault = diffAire*10;
const scalePerDeplacment = 2;

function moveFromTo(entity,xB,yB,ms,alterSpeed) {
    if (entity.deplacing) {
        return;
    }
    ...
    deplaceRec(xA,yA,xA,yA,coefX,coefY,0,params);
}


function deplaceRec(x,y,xD,yD,coefX,coefY,i,params) {
    ...
    if (entity != null) {
        ...
        entity.x = x;
        entity.y = y;
        let collision = checkCollisions(entity);
            ...
            if (typeof(collision) == "object") {
                ...
                if (typeof(collision.mulCoefX) != "undefined" & typeof(collision.mulCoefY) != "undefined") {
                    setTimeout(() => {
                        ...
                        moveEntitieTo(entity.id,direction.x,direction.y,typeof(collision.ms) != "undefined" ? collision.ms : ms);
                        entity.coefX = coefX;
                        entity.coefY = coefY;
                    }, 5);
                    return;
    ...
    entity.timeout = setTimeout(() => {
        ...
        x += coefX;
        y += coefY;
         deplaceRec(x,y,xD,yD,coefX,coefY,i+1,params);
    },ms);
}
